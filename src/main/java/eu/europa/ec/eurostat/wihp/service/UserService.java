...
import eu.europa.ec.eurostat.wihp.domain.Authority;
import eu.europa.ec.eurostat.wihp.domain.User;
import eu.europa.ec.eurostat.wihp.repository.AuthorityRepository;
import eu.europa.ec.eurostat.wihp.repository.UserRepository;
import eu.europa.ec.eurostat.wihp.security.SecurityUtils;
import eu.europa.ec.eurostat.wihp.service.dto.AdminUserDTO;
import eu.europa.ec.eurostat.wihp.service.dto.UserDTO;
...
public class UserService {
    ...
    private static void email(final Map<String, Object> details, final User user, final String sub, final String username) {
    ...
    private static void language(final Map<String, Object> details, final User user) {
