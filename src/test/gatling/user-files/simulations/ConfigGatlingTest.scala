...
class ConfigGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Config entity")
        ...
        .repeat(2) {
            ...
            .get("/services/dataacquisitionservice/api/configs")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new config")
            .post("/services/dataacquisitionservice/api/configs")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/dataacquisitionservice${new_config_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created config")
            .delete("/services/dataacquisitionservice${new_config_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
