...
class ReportGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Report entity")
        ...
        .repeat(2) {
            ...
            .get("/services/dataacquisitionservice/api/reports")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new report")
            .post("/services/dataacquisitionservice/api/reports")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "content":"SAMPLE_TEXT"
                }""")).asJson
            ...
            .repeat(5) {
                ...
                .get("/services/dataacquisitionservice${new_report_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created report")
            .delete("/services/dataacquisitionservice${new_report_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
