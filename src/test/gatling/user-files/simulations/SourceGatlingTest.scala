...
class SourceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Source entity")
        ...
        .repeat(2) {
            ...
            .get("/services/dataacquisitionservice/api/sources")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new source")
            .post("/services/dataacquisitionservice/api/sources")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/dataacquisitionservice${new_source_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created source")
            .delete("/services/dataacquisitionservice${new_source_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
