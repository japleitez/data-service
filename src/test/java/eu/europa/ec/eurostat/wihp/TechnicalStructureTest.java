...
import eu.europa.ec.eurostat.wihp.web.rest.errors.ErrorConstants;
import eu.europa.ec.eurostat.wihp.web.rest.errors.UnprocessableEntityException;

@AnalyzeClasses(packagesOf = DataAcquisitionServiceApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .optionalLayer("Service").definedBy("..service..", "..storm..")
        ...
        .ignoreDependency(belongToAnyOf(DataAcquisitionServiceApp.class), alwaysTrue())
        .ignoreDependency(alwaysTrue(), belongToAnyOf(
            eu.europa.ec.eurostat.wihp.config.Constants.class,
